...
def get_libnorm():
    ...
    if system_name == "windows":
        libnorm = ctypes.windll.LoadLibrary("norm.dll")
    else:
    ...
    libnorm.NormGetNextAckingNode.restype = ctypes.c_int
    libnorm.NormGetNextAckingNode.argtypes = [ctypes.c_void_p, ctypes.c_bool]    
